...
[![Build Status](https://travis-ci.org/lordoftheflies/vagrant.svg?branch=master)](https://travis-ci.org/lordoftheflies/ansible-role-vagrant)

## Description

Vagrant is an Ansible Role used to setup and maintain production grade services.
...
* [On Ansible Galaxy](https://galaxy.ansible.com/lordoftheflies/ansible_role_vagrant)
...
* vagrant generated using [ansible_collection_skeleton](https://github.com/<class 'jinja2.utils.Namespace'>/ansible_collection_skeleton)[![Ansible Role](https://img.shields.io/ansible/role/d/)](https://galaxy.ansible.com/lordoftheflies/ansible_role_vagrant)
[![Ansible Role](https://img.shields.io/ansible/role/)](https://galaxy.ansible.com/lordoftheflies/ansible_role_vagrant)
